...
public class HorizontalRecycleviewAdapter extends RecyclerView.Adapter<HorizontalRecycleviewAdapter.ViewHolder> {
    ...
    public HorizontalRecycleviewAdapter(Context mContext, List<Note> noteList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_horizontal_item, parent, false);
